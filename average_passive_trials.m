%%%%%%%%%%%%%%%%%%%%%%%%%%
% average_passive_trials
% Marie Moltubakk 6.2.2015
% Read two trials of torque, gonio angle, norm angle, displacement
% Produce array with average data
%%%%%%%%%%%%%%%%%%%%%%%%%%


function [output_array] = average_passive_trials(varargin) % (torque1, gonio1, angle1, displ1, torque2, gonio2, angle2, displ2)

if nargin == 8 % two trials submitted, to be averaged
    torque1 = varargin{1};
    gonio1 = varargin{2};
    %angle1 = varargin{3};
    displ1 = varargin{4};
    ...
    [~,torque1unique,ind] = consolidator(gonio1,torque1,'mean',0);
    [~,torque2unique,ind] = consolidator(gonio2,torque2,'mean',0);
    [gonio1unique,displ1unique,ind] = consolidator(gonio1,displ1,'mean',0);
    [gonio2unique,displ2unique,ind] = consolidator(gonio2,displ2,'mean',0);
    ...
    [gonio1unique,displ1unique,~] = consolidator(gonio1,displ1,'mean',0);
