...
%     end
    ...
    % extract displacement and GONIO data from FIRST movement phase plantarflexion
    ...
    if plot_norm
        ...
        saveas(fignavn, strcat('data_plots_stiff/IND_ankle_rot_displ_', subject_id, '_free'), 'png')
    end
