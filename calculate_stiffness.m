...
function stiffness = calculate_stiffness(stiff_eq, force100, percent_start, percent_stop, label)
    ...
    cprintf('blue', horzcat(' Stiffness ', label, ' ', num2str(percent_start*100), '-', num2str(percent_stop*100), ' = ', num2str(stiffness,4), ' N/mm.\n'))
end