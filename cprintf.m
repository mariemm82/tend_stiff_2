...
% $Revision: 1.09 $  $Date: 2015/03/20 11:28:14 $
  ...
  if isdeployed | ~useDesktop %#ok<OR2> - for Matlab 6 compatibility
      ...
      %awtinvoke(cmdWinDoc,'remove',lastPos,1);   % TO DO: find out how to remove the extra '_'
...
function setElementStyle(docElement,style,specialFlag, majorVersion,minorVersion)
  ...
  if isempty(links)
      ...
      %TO DO: remove hyperlink by setting the value to -1
  end
  %}
